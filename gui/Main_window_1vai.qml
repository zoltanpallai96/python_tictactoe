...
Rectangle{
        ...
        function set_tiles(){
            button00.mytext = MainWindow.get_back_position(0,0)
            button01.mytext = MainWindow.get_back_position(0,1)
            button02.mytext = MainWindow.get_back_position(0,2)
            button10.mytext = MainWindow.get_back_position(1,0)
            button11.mytext = MainWindow.get_back_position(1,1)
            button12.mytext = MainWindow.get_back_position(1,2)
            button20.mytext = MainWindow.get_back_position(2,0)
            button21.mytext = MainWindow.get_back_position(2,1)
            button22.mytext = MainWindow.get_back_position(2,2)
        }
        ...
        Component.onCompleted: set_tiles() // @disable-check M16
            ...
            rows: 3
                 ...
                 Rectangle{
                    ...
                    MouseArea{
                        ...
                        enabled: parent.mytext == " " ? true : false
